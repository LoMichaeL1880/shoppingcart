            ...
            <div class="row">
              ...
              <div class="col-lg-6 text-center text-lg-right">
                <ul class="menu list-inline mb-0">
                  ...
                  <li class="list-inline-item"><a href="register.html">Member</a></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="container"><a href="index.html" class="navbar-brand home"><img src="../img/logo.png" alt="Obaju logo" class="d-none d-md-inline-block"><img src="img/logo-small.png" alt="Obaju logo" class="d-inline-block d-md-none"><span class="sr-only">Obaju - go to homepage</span></a>
            ...
            <div id="navigation" class="collapse navbar-collapse">
              <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item"><a href="" class="nav-link" id="necklace">Necklace</a></li>
                <li class="nav-item"><a href="" class="nav-link" id="bracelet">Bracelet</a></li>
                <li class="nav-item"><a href="" class="nav-link" id="rings">Rings</a></li>
                <li class="nav-item"><a href="" class="nav-link" id="earrings">Earrings</a></li>
