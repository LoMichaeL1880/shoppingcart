        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
              ...
              <p><strong>Obaju Ltd.</strong><br>13/25 New Avenue<br>New Heaven<br>45Y 73J<br>England<br><strong>Great Britain</strong></p><a href="#">Go to contact page</a>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-6 mb-2 mb-lg-0">
              <p class="text-center text-lg-left">©2022 巨匠職訓班 Shopping Cart</p>
            </div>
            <div class="col-lg-6">
