	  ...
	  <div id="productMain" class="row">
	    ...
	    <div class="col-md-6">
	      <div data-slider-id="1" class="owl-carousel shop-detail-carousel">
	        <div class="item"> <img src="${productdetail.ppicpath }" alt="" class="img-fluid"></div>
	        <div class="item"> <img src="${productdetail.ppicpath }" alt="" class="img-fluid"></div>
	        <div class="item"> <img src="${productdetail.ppicpath }" alt="" class="img-fluid"></div>
	      </div>                  
	    </div>
	    ...
	    <div class="col-md-6">
	      <!--文字介紹-->
	      <div class="box">
	        <h1 class="text-center">${productdetail.pname }</h1>
	        <p class="goToDescription"><a href="#details" class="scroll-to">Scroll to product details, material &amp; care and sizing</a></p>
	        <p class="price">$${productdetail.pprice }</p>
	      ...
	      <div data-slider-id="1" class="owl-thumbs">
	        <button class="owl-thumb-item"><img src="${productdetail.ppicpath }" alt="" class="img-fluid"></button>
	        <button class="owl-thumb-item"><img src="${productdetail.ppicpath }" alt="" class="img-fluid"></button>
	        <button class="owl-thumb-item"><img src="${productdetail.ppicpath }" alt="" class="img-fluid"></button>
	      </div>
	    </div>
